...
do
	...
	th kfold_driver.lua -dropout_prob 0.2 -network_type fully_connected -num_folds 12 -max_presentations 1 -show_test -fold_num "$fold_num" -max_iterations 1000 -simulated $SIM_TYPE -ERP_I > $out_file
